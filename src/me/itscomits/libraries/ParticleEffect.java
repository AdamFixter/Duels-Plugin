package me.itscomits.libraries;
...
import me.itscomits.libraries.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
	 ...
	 */
	public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, double range, Location center) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
		if (!isSupported()) {
